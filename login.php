...
<head>
  <style>
    body{
    background: url(image/login-bg.webp) no-repeat center;
  ...
  <?php require 'header.php'; ?>
    ...
    <div class="tab-content">
        ...
        <form action="file/hospitalLogin.php" class="login-form" method="post">
          ...
          <input type="submit" name="hlogin" value="Login" class="btn btn-info btn-block mb-4">
        </form>
        </div>
      ...
      <div class="tab-pane container fade" id="receivers">
          ...
          <input type="submit" name="rlogin" value="Login" class="btn btn-info btn-block mb-4">
        </form>
      </div>
