...
<html lang="en">
  ...
  <body>
    <nav>
      <div class="container">
        <h1 style="border:5px solid #54B4D3; font-size: 35px; background-color:#54B4D3;text-align: center;  ">User Dashboard</h1>
      </div>
    </nav>
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="image/u-profile2.avif" alt="Los Angeles" width="1100" height="500">
          </div>
