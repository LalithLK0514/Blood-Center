...
<!DOCTYPE html>
<html>
<?php $title="Blood Center | My Profile"; ?>
<?php require 'head.php';?>
<style>
    body{
    background: url(image/h-profile.jpg) no-repeat center;
			...
			<div class="col-lg-4 col-md-4 col-sm-6 mb-5">
				<div class="card">
					...
					<div class="card-body">
						...
						<label class="text-muted font-weight-bold">Hospital Mobile Number</label>
