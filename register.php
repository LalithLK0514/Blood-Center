...
<?php $title="Blood Center | Register"; ?>
  ...
  <?php include 'header.php'; ?>
    ...
    <div class="tab-content">
        ...
        <form action="file/hospitalReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="submit" name="hregister" value="Register" class="btn btn-info btn-block mb-4">
        </form>
        ...
        <div class="tab-pane container fade" id="receivers">
          ...
          <input type="submit" name="rregister" value="Register" class="btn btn-info btn-block mb-4">
        </form>
