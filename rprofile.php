...
<!DOCTYPE html>
<html>
<?php $title="Blood Center | Receiver Profile"; ?>
<?php require 'head.php';?>
<style>
    body{
    background: url(image/u-profile.avif) no-repeat center;
			...
			<div class="col-lg-4 col-md-6 col-sm-8 mb-5">
				<div class="card">
					...
					<div class="card-body">
						...
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Receiver Mobile Number</label>
