...
<!DOCTYPE html>
<html>
<?php $title="Blood Center | Add blood samples"; ?>
  ...
  <?php require 'header.php'; ?>
    ...
    <div class="container cont">
      ...
      <div class="row justify-content-center">
        ...
        <form action="file/infoAdd.php" method="post">
        ...
        </div> <ul style="list-style-type:disc;"> <li>In good health. </li>
              <li>At least 16 or 17 years old, depending on the law in your state. Some states allow legal minors to donate with parent permission.</li> 
              <li>While there's no legal upper age limit, policies may vary between individual donor centers.</li>              
              <li>At least 110 pounds (about 50 kilograms).</li>
              <li>Able to pass the physical and health-history assessments.</li></ul>
          ...
          <input type="submit" name="add" value="Add" class="btn btn-info btn-block"><br>
